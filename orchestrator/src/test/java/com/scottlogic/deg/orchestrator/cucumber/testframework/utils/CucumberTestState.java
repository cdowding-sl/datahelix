...
public class CucumberTestState {
    ...
    public void addField(String fieldName) {
        this.profileFields.add(new Field(fieldName, null, false, null, false));
    }
    ...
    public void setFieldUnique(String fieldName) {
        ...
        Field newField = new Field(oldField.name, oldField.type, true, oldField.getFormatting(), false);
    ...
    public void setFieldType(String fieldName, Types types) {
        ...
        Field newField = new Field(oldField.name, types, oldField.isUnique(), oldField.getFormatting(), false);
    ...
    public void setFieldFormatting(String fieldName, String formatting) {
        ...
        Field newField = new Field(oldField.name, oldField.type, oldField.isUnique(), formatting, false);
