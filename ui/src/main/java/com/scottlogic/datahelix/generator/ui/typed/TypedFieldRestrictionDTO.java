...
public class TypedFieldRestrictionDTO extends TypedRestrictionDTO
{
    public final String otherField;
    public final int offset;
    public final String offsetUnit;

    public TypedFieldRestrictionDTO(String field, FieldType fieldType, ConstraintType type, String otherField, int offset, String offsetUnit)
    {
